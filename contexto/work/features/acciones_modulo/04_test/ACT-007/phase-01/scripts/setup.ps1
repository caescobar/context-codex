...
Write-OutputLog "Expected: setup validates prerequisites and discovery for ACT-007 phase-01."
...
$summaryRel = "contexto/work/features/acciones_modulo/03_execution/ACT-007/phase-01.md"
...
try {
    Invoke-Step "rg --line-number -F -e `"/api/v1/actions/rules:`" contexto/openapi/actions.yaml"
    Invoke-Step "rg --line-number -F -e `"/api/v1/actions/devices/{deviceId}/rules:`" contexto/openapi/actions.yaml"
    Invoke-Step "rg --line-number -F -e `"/api/v1/actions/rules/{ruleInstanceId}/state:`" contexto/openapi/actions.yaml"
    Invoke-Step "rg --line-number -F -e `"x-required-policy: Actions.View`" -e `"x-required-policy: Actions.Update`" contexto/openapi/actions.yaml"
    Invoke-Step "rg --line-number -F -e `"Actions.View`" -e `"Actions.Update`" telemetric-api/src/Telemetric.Api/Domain/Constants/PermissionClaims.cs"
}
finally {
    Pop-Location
}
