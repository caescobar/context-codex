...
Write-OutputLog "Expected: setup valida prerequisitos y discovery ACT-004 phase-04."
...
$phaseSummaryRel = "contexto/work/features/acciones_modulo/03_execution/ACT-004/phase-04.md"
...
try {
    Invoke-Step "rg --line-number -F '/my-devices/:id/edit' telemetric-front/src/router/MainRoutes.ts"
    Invoke-Step "rg --line-number -F `"ruleMode = ref<'local' | 'reusable'>('local')`" telemetric-front/src/features/customer/devices/views/DeviceCustomerEditView.vue"
    Invoke-Step "rg --line-number -F 'Actions.Assign' telemetric-front/src/features/customer/devices/views/DeviceCustomerEditView.vue"
    Invoke-Step "rg --line-number -F 'actionsService.createRuleFromDevice' telemetric-front/src/features/customer/devices/views/DeviceCustomerEditView.vue"
    Invoke-Step "rg --line-number -F 'Overrides JSON no es valido.' telemetric-front/src/features/customer/devices/views/DeviceCustomerEditView.vue"
    Invoke-Step "rg --line-number -F '/actions/assignments/create-from-device' telemetric-front/src/features/actions/actions.service.ts"
