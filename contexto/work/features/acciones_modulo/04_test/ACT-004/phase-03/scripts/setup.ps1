...
Write-OutputLog "Expected: setup valida prerequisitos y discovery ACT-004 phase-03."
...
$phaseSummaryRel = "contexto/work/features/acciones_modulo/03_execution/ACT-004/phase-03.md"
...
try {
    Invoke-Step "rg --line-number -F 'assignTemplateToDevices' telemetric-front/src/features/actions"
    Invoke-Step "rg --line-number -F '/actions/assignments/template-version' telemetric-front/src/features/actions/actions.service.ts"
    Invoke-Step "rg --line-number -F 'getAssignableDevices' telemetric-front/src/features/actions/actions.service.ts"
    Invoke-Step "rg --line-number -F 'RejectedDuplicate' telemetric-front/src/features/actions"
    Invoke-Step "rg --line-number -F 'Fuera de alcance' telemetric-front/src/features/actions/views"
