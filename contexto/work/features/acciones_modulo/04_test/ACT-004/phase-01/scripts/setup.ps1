...
Write-OutputLog "Expected: setup valida prerequisitos y discovery ACT-004 phase-01."
...
$phaseSummaryRel = "contexto/work/features/acciones_modulo/03_execution/ACT-004/phase-01.md"
...
try {
    Invoke-Step "rg --line-number -F 'AssignTemplateToDevices' telemetric-api/src/Telemetric.Api/Features/Actions"
    Invoke-Step "rg --line-number -F 'template-version' telemetric-api/src/Telemetric.Api/Features/Actions/Assignments/AssignTemplateToDevices/AssignTemplateToDevicesEndpoint.cs"
    Invoke-Step "rg --line-number -F 'PermissionClaims.Actions.Assign' telemetric-api/src/Telemetric.Api/Features/Actions/Assignments/AssignTemplateToDevices/AssignTemplateToDevicesEndpoint.cs telemetric-api/src/Telemetric.Api/Domain/Constants/PermissionClaims.cs"
    Invoke-Step "rg --line-number -F 'UQ_RuleInstance_Device_TemplateVersion' telemetric-api/scripts/012_create_actions_schema.sql"
    Invoke-Step "rg --line-number -F '/api/v1/actions/assignments/template-version' contexto/openapi/actions.yaml"
