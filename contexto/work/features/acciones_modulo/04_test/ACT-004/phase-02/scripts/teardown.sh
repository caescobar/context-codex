...
echo "- Teardown phase-02: no se realizaron cambios destructivos." >> "$NOTES_FILE"
echo "- Regla de cierre: si se levantaron instancias durante QA, deben quedar apagadas y verificadas como detenidas." >> "$NOTES_FILE"
