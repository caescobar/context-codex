...
Add-Content -Path $NotesFile -Value "- Teardown phase-02: no se realizaron cambios destructivos."
Add-Content -Path $NotesFile -Value "- Regla de cierre: si se levantaron instancias durante QA, deben quedar apagadas y verificadas como detenidas."
