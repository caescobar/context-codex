...
Write-OutputLog "Expected: setup valida prerequisitos y discovery ACT-004 phase-02."
...
$phaseSummaryRel = "contexto/work/features/acciones_modulo/03_execution/ACT-004/phase-02.md"
...
try {
    Invoke-Step "rg --line-number -F 'CreateRuleFromDevice' telemetric-api/src/Telemetric.Api/Features/Actions"
    Invoke-Step "rg --line-number -F '/api/v1/actions/assignments/create-from-device' telemetric-api/src/Telemetric.Api/Features/Actions/Assignments/CreateRuleFromDevice/CreateRuleFromDeviceEndpoint.cs contexto/openapi/actions.yaml"
    Invoke-Step "rg --line-number -F 'PermissionClaims.Actions.Assign' telemetric-api/src/Telemetric.Api/Features/Actions/Assignments/CreateRuleFromDevice/CreateRuleFromDeviceEndpoint.cs telemetric-api/src/Telemetric.Api/Domain/Constants/PermissionClaims.cs"
    Invoke-Step "rg --line-number -F 'threshold' telemetric-api/src/Telemetric.Api/Features/Actions/Assignments/CreateRuleFromDevice/CreateRuleFromDeviceCommandHandler.cs"
    Invoke-Step "rg --line-number -F 'email.recipients' telemetric-api/src/Telemetric.Api/Features/Actions/Assignments/CreateRuleFromDevice/CreateRuleFromDeviceCommandHandler.cs"
    Invoke-Step "rg --line-number -F 'is not allowed in v1' telemetric-api/src/Telemetric.Api/Features/Actions/Assignments/CreateRuleFromDevice/CreateRuleFromDeviceCommandHandler.cs"
