...
Add-Content -Path $CommandsLog -Value ("{0} | teardown phase-01 (safe no-op), DRY_RUN={1}" -f (Get-Date -Format s), $DryRun)
...
Add-Content -Path $NotesFile -Value "- Teardown phase-01: no destructive actions were performed."
