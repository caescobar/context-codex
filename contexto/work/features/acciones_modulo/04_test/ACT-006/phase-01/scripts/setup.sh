...
log_output "Expected: setup validates prerequisites and discovery for ACT-006 phase-01."
...
run_step "rg --line-number -F -e '/api/v1/actions/runs:' contexto/openapi/actions.yaml"
run_step "rg --line-number -F -e '/api/v1/actions/templates/{ruleTemplateId}/runs:' contexto/openapi/actions.yaml"
run_step "rg --line-number -F -e 'x-required-policy: Actions.View' contexto/openapi/actions.yaml"
run_step "rg --line-number -F -e 'Policies(PermissionClaims.Actions.View)' telemetric-api/src/Telemetric.Api/Features/Actions"
popd >/dev/null
