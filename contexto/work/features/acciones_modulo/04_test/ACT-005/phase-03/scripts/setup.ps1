...
Write-OutputLog "Expected: setup valida prerequisitos y discovery ACT-005 phase-03."
...
$phaseSummaryRel = "contexto/work/features/acciones_modulo/03_execution/ACT-005/phase-03.md"
...
try {
    Invoke-Step "rg --line-number -F 'validateAndBuild' telemetric-front/src/features/actions/views/ActionsTemplatesView.vue"
    Invoke-Step "rg --line-number -F 'durationSeconds no puede ser mayor que windowSeconds.' telemetric-front/src/features/actions/views/ActionsTemplatesView.vue"
    Invoke-Step "rg --line-number -F 'ttlSeconds invalido para HOLD_LAST_VALUE.' telemetric-front/src/features/actions/views/ActionsTemplatesView.vue"
    Invoke-Step "rg --line-number -F 'Debe ingresar al menos un destinatario.' telemetric-front/src/features/actions/views/ActionsTemplatesView.vue"
    Invoke-Step "rg --line-number -F ""path: '/actions'"" telemetric-front/src/features/actions/actions.routes.ts"
    Invoke-Step "rg --line-number -F ""requiresPermission: 'Actions.View'"" telemetric-front/src/features/actions/actions.routes.ts telemetric-front/src/layouts/menuItems.ts"
