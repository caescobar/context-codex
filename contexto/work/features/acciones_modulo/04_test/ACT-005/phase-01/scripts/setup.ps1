...
Write-OutputLog "Expected: setup valida prerequisitos y discovery ACT-005 phase-01."
...
$phaseSummaryRel = "contexto/work/features/acciones_modulo/03_execution/ACT-005/phase-01.md"
$frontendTypesRel = "telemetric-front/src/features/actions/types.ts"
...
foreach ($rel in @($launchSettingsRel, $phaseSummaryRel, $frontendTypesRel, $openApiRel, $frontendPackageRel)) {
...
try {
    ...
    Invoke-Step "rg --line-number -F 'discriminator' contexto/openapi/actions.yaml"
    Invoke-Step "rg --line-number -F 'ruleType' contexto/openapi/actions.yaml"
    Invoke-Step "rg --line-number -F 'JsonValueKind.Object' telemetric-api/src/Telemetric.Api/Features/Actions/Templates/CreateTemplate/CreateTemplateEndpoint.cs telemetric-api/src/Telemetric.Api/Features/Actions/Templates/UpdateTemplate/UpdateTemplateEndpoint.cs"
    Invoke-Step "rg --line-number -F 'GetRawText' telemetric-api/src/Telemetric.Api/Features/Actions/Templates/CreateTemplate/CreateTemplateEndpoint.cs telemetric-api/src/Telemetric.Api/Features/Actions/Templates/UpdateTemplate/UpdateTemplateEndpoint.cs"
    Invoke-Step "rg --line-number -F 'ruleTemplateId' telemetric-api/src/Telemetric.Api/Features/Actions/Templates/UpdateTemplate/UpdateTemplateEndpoint.cs"
    Invoke-Step "rg --line-number -F 'export type RuleType' telemetric-front/src/features/actions/types.ts"
    Invoke-Step "rg --line-number -F 'durationSeconds' telemetric-front/src/features/actions/types.ts"
