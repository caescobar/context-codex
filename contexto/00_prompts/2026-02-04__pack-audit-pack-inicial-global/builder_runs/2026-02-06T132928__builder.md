...
Quiero generar el PROMPT FINAL para ejecutar PHASE-01 basada en la sección “Plan sugerido por fases”, Fase 3.
...
## Rationale
- Es un cambio acotado con objetivo y archivos definidos en el plan por fases.
- El alcance esta limitado a 5 archivos, habilitando ejecucion por fase.
