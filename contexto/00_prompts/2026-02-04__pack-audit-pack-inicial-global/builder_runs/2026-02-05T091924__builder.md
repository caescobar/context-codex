...
- Rationale:
  ...
  - Busca evidencia reproducible de invariantes (no DeviceId=0 y platform_id obligatorio).
...
Contexto tecnico: stack docker-compose; endpoint Hub: POST /api/v1/ingest-raw (formato 'serial.payload'); existe hostigador que simula dispositivo; Redis es fuente de config.
